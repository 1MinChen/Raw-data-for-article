...
##
##time.
coxm_1 = cph(Surv(time,status)~risk_score+T_stage+N_stage+M_stage+clinical_stage+alcohol_history+cigarettes_per_day+Age+barretts_esophagus, data=data, surv=T, x=T, y=T, time.inc=365*1)
cal_1 = calibrate(coxm_1, u=365*1, cmethod='KM', m=30, B=1000)
##
